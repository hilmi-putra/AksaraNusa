...
const categories = [
  { id: "terlaris", label: "Buku Terlaris", color: "bg-[#F9990E]", rotate: 30, zClass: "z-10", left: "left-[5%]" },
  { id: "fiksi", label: "Buku Fiksi", color: "bg-[#E0790A]", rotate: 24, zClass: "z-20", left: "left-[30%]" },
  { id: "non-fiksi", label: "Non-Fiksi", color: "bg-[#9A5200]", rotate: 18, zClass: "z-30", left: "left-[55%]" },
  { id: "anak", label: "Buku Anak", color: "bg-[#FCD291]", rotate: 12, zClass: "z-40", left: "left-[80%]" }
];
...
export function StoreHeroSection() {
  ...
  return (
    <section
      className="pt-16 md:pt-32 overflow-hidden border-b-2 border-[#F9990E]"
      style={{
        backgroundColor: "#FCF9F5",
        backgroundImage: `
          linear-gradient(to right, rgba(249, 153, 14, 0.4) 1px, transparent 1px),
          linear-gradient(to bottom, rgba(249, 153, 14, 0.4) 1px, transparent 1px)
        `,
          ...
          <div className="flex flex-col items-start max-w-lg pb-16 relative z-10">
            ...
            <div className="flex items-center text-[80px] md:text-[110px] font-sans font-bold leading-none text-[#171512] tracking-tighter mb-10">
              ...
              <div className="flex items-center -mx-2 z-10">
                ...
                <svg width="60" height="150" viewBox="0 0 60 150" className="md:w-[85px] md:h-[210px] rotate-[15deg] z-10" fill="none">
                  <rect x="5" y="5" width="50" height="140" rx="25" stroke="#F9990E" strokeWidth="10" />
                </svg>
                {/* Right O */}
                <svg width="60" height="150" viewBox="0 0 60 150" className="md:w-[85px] md:h-[210px] -ml-6 md:-ml-8 rotate-[-5deg] z-0" fill="none">
                  <rect x="5" y="5" width="50" height="140" rx="25" stroke="#E0790A" strokeWidth="10" />
                </svg>
              </div>
            ...
            <div className="flex items-center gap-4 mb-16">
              <div className="flex items-center justify-between border-2 border-[#171512] rounded-full px-4 py-2 w-56 md:w-64 bg-white hover:bg-gray-50 transition-colors cursor-pointer">
                ...
                <Link href="/bookstore/koleksi/semua" className="bg-[#F9990E] text-white p-1 rounded-full hover:bg-[#E0790A] transition-colors">
            ...
            <p className="text-xl md:text-2xl font-medium text-[#171512] leading-snug">
              Belum tahu ingin baca apa hari ini? Temukan <Link href="/bookstore/koleksi/semua" className="underline decoration-[#F9990E] decoration-2 underline-offset-4 hover:text-[#F9990E] transition-colors">inspirasi bacaan</Link> terbaik terbitan Mega Press untuk menemani keseharian Anda.
            </p>
          </div>
          ...
          <div className="w-full md:w-1/2 h-[450px] md:h-[550px] relative z-10">
            {categories.map((cat, index) => (
              ...
              >
                ...
                >
                  {/* Arrow Circle Top */}
                  <div className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-[#171512] flex items-center justify-center">
                    <ArrowRight className="w-5 h-5 text-white" />
                  </div>

                  {/* Spine Text */}
                  <span className="text-[#171512] font-semibold text-xl md:text-2xl lg:text-3xl whitespace-nowrap tracking-wider mb-8" style={{ writingMode: "vertical-rl", transform: "rotate(180deg)" }}>
                    {cat.label}
                  </span>
                </Link>
              </div>
