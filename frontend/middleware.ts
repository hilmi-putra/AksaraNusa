...
export function middleware(request: NextRequest) {
  ...
  const cspHeader = `
    ...
    connect-src 'self' http://localhost:* ws://localhost:* https://megapress.co.id https://api.aksaranusamediatama.com https://app.sandbox.midtrans.com https://api.sandbox.midtrans.com https://app.midtrans.com https://api.midtrans.com https://api.iconify.design https://api.simplesvg.com https://api.unisvg.com;
