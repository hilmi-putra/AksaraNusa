...
| Katalog | Menuju Aksara Nusa Bookstore (`/katalog` atau domain terpisah) |
...
- 2 ikon bulat di ujung kanan header: WhatsApp & Email/Telegram (sesuai channel yang dipakai Aksara Nusa).
