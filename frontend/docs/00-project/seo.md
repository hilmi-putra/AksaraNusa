# SEO Strategy — Landing Page Mega Press
...
## Metadata
- `title`: "Mega Press — Penerbit Buku Ajar, Novel, hingga Jurnal Ilmiah"
...
## Struktur Heading
- Satu `<h1>` per halaman: judul hero ("Satu Penerbit. Ribuan Cerita Penting." — versi Mega Press dari pola mockup).
- `<h2>` untuk tiap section (Tentang Kami, Kenapa Mega Press, Katalog Unggulan, Bagaimana Prosesnya).
...
## Internal Linking
- CTA "Lihat Katalog" → Mega Bookstore (`rel` normal, bukan `nofollow`, karena internal).
- Link ke Blog Mega Press untuk memperkuat topical relevance seputar dunia penerbitan.
